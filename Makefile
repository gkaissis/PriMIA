...
federated_secure_segmentation:
	...
	python train.py --config configs/torch/segmentation.ini --train_federated --bin-seg --data_dir /Task03_Liver
	@echo Finished Training on VirtualWorkers with SecAgg
...
make federated_DP_secure_segmentation:
	python train.py --config configs/torch/segmentation-DP.ini --train_federated --bin-seg --data_dir /Task03_Liver
...
federated_insecure_segmentation: 
	@echo Training a Seg-Net on VirtualWorkers without SecAgg
	python train.py --config configs/torch/segmentation.ini --train_federated --unencrypted_aggregation --bin-seg --data_dir /Task03_Liver
	@echo Finished Training on VirtualWorkers without SecAgg
...
local_segmentation:
	...
	python train.py --config configs/torch/segmentation.ini --cuda --verbose --bin-seg --data_dir /Task03_Liver
	@echo Finished Training Locally
